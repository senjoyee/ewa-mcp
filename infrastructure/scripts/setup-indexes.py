...
def create_ewa_docs_index(client: SearchIndexClient):
    ...
    fields = [
        ...
        SimpleField(name="analysis_from", type=SearchFieldDataType.DateTimeOffset, filterable=True, sortable=True),
        SimpleField(name="analysis_to", type=SearchFieldDataType.DateTimeOffset, filterable=True, sortable=True),
